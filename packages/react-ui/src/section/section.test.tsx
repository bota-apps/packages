...
import { CheckItem, Section, SectionTitle, StepIndicator, sectionVariants } from "./index";
...
describe("Section", () => {
  ...
  it("renders CheckItem content", () => {
    render(<CheckItem icon={<svg data-testid="check-icon" />}>Free forever</CheckItem>);
