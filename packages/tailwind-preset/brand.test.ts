...
const shippedBrands: readonly { file: string; options: BrandCssOptions }[] = [
  ...
  {
    file: "freightSunrise.css",
    options: {
      name: "freightSunrise",
      // Sunrise orange: a vibrant modern orange over warm sand neutrals —
      // energetic without drifting into hazard/warning territory; semantic
      // status tones stay on the shared theme tokens.
      primary: "#FF6A00",
      accent: "#FFB02E",
      radius: "0.5rem",
      fontSans:
      ...
      tokens: {
        ...
        foreground: "22 26% 14%",
        card: "0 0% 100%",
        cardForeground: "22 26% 14%",
        popover: "0 0% 100%",
        popoverForeground: "22 26% 14%",
        secondary: "36 32% 95%",
        secondaryForeground: "22 22% 22%",
        muted: "35 28% 95%",
        mutedForeground: "24 12% 42%",
        border: "34 28% 88%",
        input: "34 28% 88%",
        sidebarBackground: "24 100% 52%",
        sidebarForeground: "0 0% 100%",
        // Selection sits deeper than the saturated rail so white selected
        // text keeps AA (the collection rule).
        sidebarAccent: "21 96% 42%",
        sidebarAccentForeground: "0 0% 100%",
        sidebarBorder: "22 90% 44%",
        sidebarPrimary: "0 0% 100%",
        sidebarRing: "42 100% 88%",
        // Warm-tinted elevation instead of the neutral navy defaults.
        shadowRaised: "0 2px 6px hsl(24 80% 25% / 0.08)",
        shadowOverlay: "0 10px 30px hsl(24 70% 25% / 0.12)",
        shadowFloating: "0 16px 36px hsl(24 65% 20% / 0.16)",
        // Amber-family chart-3 keeps its slot distinct from the primary.
        chart2: "188 72% 42%",
        chart3: "42 95% 55%",
        chart4: "214 55% 46%",
        chart5: "0 72% 55%",
        ...
        chart8: "210 76% 48%",
        mapPanelBackground: "0 0% 100%",
        mapPanelForeground: "22 26% 14%",
        mapPanelBorder: "34 28% 88%",
        mapPanelShadow:
          "0 4px 6px -1px hsl(24 60% 20% / 0.1), 0 2px 4px -2px hsl(24 60% 20% / 0.1)",
        mapMarkerDefault: "24 45% 48%",
        mapMarkerSelected: "24 100% 52%",
        mapMarkerWarning: "32 95% 44%",
        mapMarkerCritical: "0 72% 46%",
        mapClusterBackground: "20 92% 40%",
        mapClusterForeground: "0 0% 100%",
        mapRoutePlanned: "24 100% 52%",
        mapRouteObserved: "188 72% 38%",
        mapRouteCompleted: "26 10% 58%",
        mapRouteException: "0 72% 46%",
        mapLocationLive: "142 64% 33%",
        // Reported freshness borrows blue here — the shared orange cue would
        // vanish against an orange identity.
        mapLocationReported: "210 70% 45%",
        mapLocationEstimated: "262 55% 52%",
        mapLocationStale: "26 8% 55%",
        mapOverlayScrim: "hsl(22 50% 10% / 0.5)",
      },
      darkTokens: {
        primary: "25 100% 60%",
        // Lifted dark primaries carry dark text — white would fail AA.
        primaryForeground: "22 18% 9%",
        ring: "25 100% 60%",
        accent: "38 100% 62%",
        accentForeground: "24 30% 10%",
        background: "22 18% 9%",
        foreground: "35 28% 92%",
        card: "22 18% 12%",
        ...
        secondary: "22 14% 16%",
        secondaryForeground: "35 22% 88%",
        muted: "22 14% 16%",
        mutedForeground: "28 10% 66%",
        border: "22 14% 20%",
        input: "22 14% 20%",
        sidebarBackground: "24 72% 22%",
        sidebarForeground: "35 35% 94%",
        sidebarAccent: "24 90% 34%",
        sidebarAccentForeground: "0 0% 100%",
        sidebarBorder: "24 60% 18%",
        sidebarPrimary: "35 100% 85%",
        sidebarRing: "35 100% 82%",
        shadowRaised: "0 1px 2px 0 hsl(0 0% 0% / 0.5)",
        shadowOverlay: "0 4px 6px -1px hsl(0 0% 0% / 0.55), 0 2px 4px -2px hsl(0 0% 0% / 0.45)",
        shadowFloating: "0 10px 15px -3px hsl(0 0% 0% / 0.6), 0 4px 6px -4px hsl(0 0% 0% / 0.5)",
        chart2: "188 72% 52%",
        chart3: "42 95% 62%",
        chart4: "214 60% 60%",
        chart5: "0 91% 71%",
        ...
        chart7: "270 60% 70%",
        chart8: "210 80% 60%",
        mapPanelBackground: "22 18% 12%",
        mapPanelForeground: "35 28% 90%",
        mapPanelBorder: "22 14% 22%",
        mapPanelShadow: "0 4px 6px -1px hsl(0 0% 0% / 0.5), 0 2px 4px -2px hsl(0 0% 0% / 0.4)",
        mapMarkerDefault: "26 35% 62%",
        mapMarkerSelected: "25 100% 60%",
        mapMarkerWarning: "38 90% 56%",
        mapMarkerCritical: "0 78% 58%",
        mapClusterBackground: "25 100% 60%",
        mapClusterForeground: "22 18% 9%",
        mapRoutePlanned: "25 100% 60%",
        mapRouteObserved: "188 62% 50%",
        mapRouteCompleted: "26 10% 48%",
        mapRouteException: "0 78% 58%",
        mapLocationLive: "142 58% 48%",
        mapLocationReported: "210 75% 60%",
        mapLocationEstimated: "262 62% 66%",
        mapLocationStale: "26 8% 48%",
        mapOverlayScrim: "hsl(22 50% 3% / 0.6)",
      },
      surfaces: {
        operations: {
          tokens: {
